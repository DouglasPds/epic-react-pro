...
const nameBook = 'The Lord of the Rings'
...
describe('smoke', () => {
  it('should allow a typical user flow', () => {
    ...
    cy.findByRole('main').within(() => {
      cy.findByRole('searchbox', {name: /search/i}).type(`${nameBook}{enter}`)
      cy.findByRole('listitem', {name: nameBook}).within(() => {
    ...
    cy.findByRole('main').within(() => {
      ...
      cy.findByRole('link', {name: nameBook}).click()
    })

    cy.findByRole('main').within(() => {
      cy.findByRole('textbox', {name: /notes/i}).type('something')
    ...
    cy.findByRole('main').within(() => {
      ...
      cy.findByRole('listitem', {name: nameBook}).click()
    })
