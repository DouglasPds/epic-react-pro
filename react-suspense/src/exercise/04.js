...
const PokemonCacheProvider = ({children, cacheTime}) => {
  ...
  return (
    <PokemonContext.Provider value={{getPokemonResource, cacheTime}}>
      {children}
...
const usePokemonContext = () => {
  ...
  if (!context) {
    throw new Error('usePokemonContext must be used within PokemonCacheProvider')
  }
  return context
}
...
function App() {
  ...
  React.useEffect(() => {
    ...
    startTransition(() => {
      ...
      setPokemonResource(context.getPokemonResource(pokemonName))
    })
  }, [context, pokemonName, startTransition])
